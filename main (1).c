...
{
    printf("Amberol Not Installed.");
}

                                      printf("Would You Like To Install Parabolic? [Y/N]");      

                                                     fgets(Parabolic,sizeof(Parabolic),stdin);
...
{
    printf("Parabolic Not Installed.");
}  

                                                          printf("Would You Like To Install Bottles? [Y/N]")     ;    

                                                     fgets(Bottles,sizeof(Bottles),stdin);
...
{
    printf("Bottles Not Installed.");
}  

                                                                 printf("Would You Like To Install Lutris? [Y/N]");  

                                                     fgets(Lutris,sizeof(Lutris),stdin);
...
{
    printf("Lutris Not Installed.");
}           

                                                                                     printf("Would You Like To Install Wine? [Y/N]");         

                                                     fgets(Wine,sizeof(Wine),stdin);
Wine[strcspn(Wine, "\n")] = 0;
...
{
    printf("Wine Not Installed.");
}    

                                                                                                         printf("Would You Like To Install Steam? [Y/N]");         

                                                     fgets(Steam,sizeof(Steam),stdin);
Steam[strcspn(Steam, "\n")] = 0;
